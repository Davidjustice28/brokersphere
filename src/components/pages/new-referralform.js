...
function NewReferralForm(props) {
    return (
        <div id="referral-formdiv">
            <Header leftIcon ="arrow_back" pageName="Referral Form" backFunc ={props.backFunc}/>
            <div id = "new-referral">
                <form>
                    ...
                    <button onClick={props.createFunc} type= "button">Create Referral</button>
                </form>
            </div>
        </div>
    )
